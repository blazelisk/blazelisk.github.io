                ...
                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                  <div className="col-md-12">
                    <div className="about-desc">
                      ...
                      <p> After receiving my undergraduate degree, I began to pursue a master's degree in education from Johns Hopkins University. I left the program after a year as although I found the field itself to be emotionally rewarding, I eventually began to miss doing quantitative and research based work. I am excited to go back towards this field and resume doing work that matches my skillset.</p>
                    </div>
                  </div>
                </div>
              </div>
