...
export default class Hero extends Component{
    render() {
        return(
            <section id="colorlib-hero" className="js-fullheight" data-section="home" style={{height: '977px'}}>
            <div className="flexslider js-fullheight" style={{height: '977px'}}>
              <ul className="slides">
                <li style={{backgroundImage: 'url("images/img_bg_1.jpg")', width: '100%', float: 'left', marginRight: '-100%', position: 'relative', opacity: 0, display: 'block', zIndex: 1}} className data-thumb-alt>
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text" style={{height: '977px'}}>
                        <div className="slider-text-inner js-fullheight" style={{height: '977px'}}>
                          <div className="desc">
                ...
                <li style={{backgroundImage: 'url("images/img_bg_2.jpg")', width: '100%', float: 'left', marginRight: '-100%', position: 'relative', opacity: 1, display: 'block', zIndex: 2}} data-thumb-alt className="flex-active-slide">
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-md-6 col-md-offset-3 col-md-pull-3 col-sm-12 col-xs-12 js-fullheight slider-text animated fadeInUp" style={{height: '977px'}}>
